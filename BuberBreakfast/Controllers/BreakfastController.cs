...
public class BreakfastController : ControllerBase
{
    ...
    public IActionResult CreateBreakfast(CreateBreakfastRequest request)
    {
        ...
        var response = new BreakfastResponse(breakfast.Id, breakfast.Name, breakfast.Description,
            breakfast.StartDateTime, breakfast.EndDateTime, breakfast.LastModifiedDateTime, breakfast.Savory,
            breakfast.Sweet);
